...
import { Trash2, Minus, Plus, ShieldCheck, Truck, ChevronRight } from 'lucide-react';
          ...
          <div className="bg-white rounded-lg p-4 sticky top-4">
            ...
            <div className="border-t my-4 pt-4">
              <div className="flex justify-between">
                ...
                <span className="text-2xl font-semibold text-gray-800">{formatPrice(cartTotal)}</span>
              </div>
              <p className="text-sm text-[#00A650] mt-1">
                em até 12x {formatPrice(cartTotal / 12)} sem juros
              </p>
            </div>
          ...
          <div className="bg-white rounded-lg max-w-md w-full p-6">
            ...
            <div className="flex gap-3">
              ...
              <button 
                ...
                className="flex-1 bg-[#3483FA] text-white py-2 rounded hover:bg-[#2968c8]"
              >
                Confirmar
              </button>
            </div>
